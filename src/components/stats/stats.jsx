  ...
  return (
    <div className="container  stats-page position-relative z-0">
      ...
      <div className="border border-2 main_stats my-5 gap-5">
        <div>
          {' '}
          All Time <span className="px-2">0</span> <i class="fa-solid fa-eye ps-2"></i>
        </div>
        <div>
          {' '}
          Today <span className="px-2">0</span> <i class="fa-solid fa-eye ps-2"></i>
        </div>
        <div>
          {' '}
          Yesterday <span className="px-2">0</span> <i class="fa-solid fa-eye ps-2"></i>
        </div>
        <div>
          {' '}
          This Month <span className="px-2">0</span> <i class="fa-solid fa-eye ps-2"></i>
        </div>
        <div>
          {' '}
          Last Month <span className="px-2">0</span> <i class="fa-solid fa-eye ps-2"></i>
        </div>
      </div>
