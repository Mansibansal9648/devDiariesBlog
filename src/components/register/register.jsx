      ...
      <div className="container text-center register-form-container position-relative z-0">
        <div className="row">
          <div className="col mt-5 ">
            <h1 className="heading mt-3 mb-3 fs-1 fw-bold" style={{ color: '#2B3654' }}>
              Join DevDiaries Today
            </h1>
            <p className="fs-4">Empower Your Coding Journey!</p>
            <p className="me-5 ms-5 text-muted">
              We’re thrilled to have you join our growing community of passionate developers, coders, and tech
              enthusiasts. At DevDiariesBlog, we believe that coding is not just about writing lines of code—it's about
              learning, growing, and sharing experiences with like-minded individuals.By becoming a part of our
              community, you’re not just getting access to expert insights and tutorials but also becoming a valued
              contributor to a collaborative space where knowledge is freely exchanged. Whether you're a seasoned
              professional or just beginning your journey in development, DevDiariesBlog has something for everyone.
            </p>
            <p className="me-5 ms-5 text-muted ">
              ...
              skills to the next level. So, dive in, connect with others, and let’s code, learn, and innovate together.
              Your development journey starts here—and we’re excited to be part of it with you!
            </p>
          </div>
          <div className="col">
            <form className="container register-form" onSubmit={formik.handleSubmit}>
