...
const slidesContent = [
  ...
  {
    content: (
      <div style={{backgroundImage: `url('https://www.nti-audio.com/Portals/0/EasyDNNnews/511/Job_PC_Software_Developer.jpg')`, backgroundSize: 'cover', // Ensure the image covers the entire area
        backgroundPosition: 'center', height: '100vh', // Set height for the slide
